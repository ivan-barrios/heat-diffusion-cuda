...
// se acepta pero no se usa en esta implementación con coalescencia simple.
...
void update_simulation()
{
    ...
    // 1) Configuración de la grilla de hilos (32x8 para acceso coalescente)
    dim3 block(32, 8); // 256 hilos por bloque (8 warps)
    ...
    printf("Tiempo diffuse5_kernel (coalescencia): %f ms\n", ms_diff);
